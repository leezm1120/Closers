 ...
 */
public class MeiZhiRecyclerViewAdapter extends RecyclerView.Adapter{

    private  List<GankBean.ResultsBean> list = new ArrayList<>();
    private Activity context;
    private ImageOptions imageOptions;

    public MeiZhiRecyclerViewAdapter(Activity context, List<GankBean.ResultsBean> list){
        this.list = list;
...
//        public TextView textView;
        ...
        public MainHolder(View itemView) {
            super(itemView);
            this.imageView = (ImageView) itemView.findViewById(R.id.meizhi_imageView);
//            this.textView = (TextView) itemView.findViewById(R.id.main_textView);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(context).inflate(R.layout.meizhi_recycler_view,null);
...
//        mainHolder.textView.setText(list.get(position).getItem());
        x.image().bind(mainHolder.imageView,list.get(position).getUrl());
        //判断是否设置了监听器
